...
final class Version20240328155304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE db_orders.usersOrders ("user" UUID NOT NULL, orders_id UUID NOT NULL, payment_intent VARCHAR(50) NOT NULL, amount DOUBLE PRECISION NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(orders_id, "user"))');
        $this->addSql('CREATE INDEX IDX_EC4A0825CFFE9AD6 ON db_orders.usersOrders (orders_id)');
        $this->addSql('COMMENT ON COLUMN db_orders.usersOrders."user" IS \'(DC2Type:uuid)\'');
